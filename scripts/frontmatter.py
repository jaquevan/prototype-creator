...
SCHEMAS = {
    'prototype': {
        ...
        'fidelity': {'type': 'string', 'required': True, 'values': ['low', 'medium', 'high']},
    ...
    'review': {
        'prototype_id': {'type': 'string', 'required': True},
        'dimension': {'type': 'string', 'required': True, 'values': ['completeness', 'usability', 'feasibility', 'fidelity_match', 'summary']},
    ...
    'submission': {
        'prototype_id': {'type': 'string', 'required': True},
        'target': {'type': 'string', 'required': True, 'values': ['apollo', 'repo', 'local']},
