...
Output (JSON to stdout):
    {
      ...
      "files_committed": 6,
      "workflow": "fork",
      "pages_url": "https://example.pages.redhat.com/mr-42/",
...
def extract_project_path(remote_url):
    """Extract the GitLab project path (e.g. 'uxd/prototypes/rhoai') from a remote URL.
...
def resolve_pages_url(mr_iid, branch_name, pages_base_url):
    ...
    Convention in the RHOAI prototypes repo:
