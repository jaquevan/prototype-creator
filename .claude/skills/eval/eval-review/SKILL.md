---
name: eval-review
description: "Review eval results conversationally. Reads artifacts, presents narrative summary, offers to fix issues or explain findings. The designer-facing entry point to eval output."
user-invocable: true
...
/eval-review RHAISTRAT-1536 --workspace=~/Desktop/rhoai-prototypes
```
