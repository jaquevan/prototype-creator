...
const COLUMNS = [
  ...
  { header: 'Andy Lo-fi',       width: 65  },
  { header: 'Andy Hi-fi',       width: 65  },
...
function main() {
  ...
  // Andy's ground truth (designer manual evaluations)
  const groundTruth = {
    'RHAISTRAT-1527': { lofi: 'Pass', hifi: 'Pass' },
    'RHAISTRAT-133': { lofi: 'Pass', hifi: 'Fail' },
    'RHAISTRAT-1492': { lofi: 'Pass', hifi: 'IDK' },
    'RHAISTRAT-1267': { lofi: 'Pass', hifi: 'Fail' },
    'RHAISTRAT-1536': { lofi: 'Pass', hifi: 'IDK' },
    'RHAISTRAT-1535': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-1745': { lofi: 'Pass', hifi: 'IDK' },
    'RHAISTRAT-1474': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-1740': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-432': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-1521': { lofi: 'Pass', hifi: 'Fail' },
    'RHAISTRAT-1433': { lofi: 'Pass', hifi: 'IDK' },
    'RHAISTRAT-1762': { lofi: 'Pass', hifi: 'IDK' },
    'RHAISTRAT-1761': { lofi: 'N/A', hifi: 'N/A' },
    'RHAISTRAT-1758': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-1744': { lofi: 'Fail', hifi: 'Fail' },
    'RHAISTRAT-1742': { lofi: 'Pass', hifi: 'Fail' },
    'RHAISTRAT-1741': { lofi: 'Pass', hifi: 'Fail' },
  };
  ...
  const ORIG_COLUMNS = [
    ...
    { header: 'Usability', width: 70 }, { header: 'Andy Lo-fi', width: 65 },
    { header: 'Andy Hi-fi', width: 65 }, { header: 'Agree', width: 50 },
  ...
  for (const r of results) {
    ...
    const andyLofi = gt.lofi || '—';
    const andyHifi = gt.hifi || '—';
    const aOrigPass = r.origResult === 'Pass';
    const dPass = andyLofi.toLowerCase().startsWith('pass');
    const agree = (andyLofi === '—' || andyLofi === 'N/A') ? '—' : (dPass === aOrigPass ? 'Yes' : 'No');
    ...
    origRows.push([
      ...
      r.origUsability, andyLofi, andyHifi, agree, origReportCell, r.evalDate
    ]);
