...
The evaluator should work for any product team at Red Hat — not just OpenShift AI. By extracting product-specific assumptions into `config/product-overlay.yaml`, a new team can adopt the skill by creating their own overlay file.
...
| `personas` | Which persona YAML files to use for usability scoring |
